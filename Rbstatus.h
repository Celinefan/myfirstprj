...
*
* $Version: $
* $Archive: /Rainbow Script Engine/MISC/SAMPLES/X86/SX/WIN32/rbstatus.h $
* $Revision: 6 $
* $Header: /Rainbow Script Engine/MISC/SAMPLES/X86/SX/WIN32/rbstatus.h 6     8/25/97 9:10a Bgrove $
* $Author: Bgrove $
* $Date: 8/25/97 9:10a $
*
* $History: rbstatus.h $
...
#define SKCMD_UNKNOWN_MACH            -803  /* unkown machine type */
