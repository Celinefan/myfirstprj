...
*
* $Version: $
* $Archive: /Rainbow Script Engine/MISC/SAMPLES/X86/SX/WIN32/rbcommon.h $
* $Revision: 2 $
* $Header: /Rainbow Script Engine/MISC/SAMPLES/X86/SX/WIN32/rbcommon.h 2     8/25/97 9:10a Bgrove $
* $Author: Bgrove $
* $Date: 8/25/97 9:10a $
*
* $History: rbcommon.h $
